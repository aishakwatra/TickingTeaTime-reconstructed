...
public:
    MainPage() : Page(MAINPAGE), audioManager(AudioManager::GetInstance())
    {
        ...
        // DRAGGABLE PAPERS
        UIDraggable *CaseNews = new UIDraggable("CaseNews", "Assets/Images/Journal/CaseSummary_News.png",
            glm::vec3(-3.2f, 0.0f, 0.0f), glm::vec3(5.34f, 6.85f, 0.0f), true);
        CaseNews->setDragBoundsByObject(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(12.68f, 7.45f, 1.0f));

        UIDraggable *Ticket = new UIDraggable("Ticket", "Assets/Images/Journal/CaseSummary_Ticket.png",
            glm::vec3(-3.6f, -2.5f, 1.0f), glm::vec3(4.18f, 1.65f, 0.0f), true);
        ...
        UIButton *Suspect1 = new UIButton("Suspect1", "Assets/Images/Journal/CaseSummary_Icon_Martha.png",
            glm::vec3(1.3f, 2.05f, 0.0f), glm::vec3(1.05f, 0.99f, 0.0f), true, false, "");
        ...
        UIButton *Suspect2 = new UIButton("Suspect2", "Assets/Images/Journal/CaseSummary_Icon_Nathaniel.png",
            glm::vec3(2.75f, 2.02f, 0.0f), glm::vec3(1.05f, 0.99f, 0.0f), true, false, "");
        ...
        UIButton *Suspect3 = new UIButton("Suspect3", "Assets/Images/Journal/CaseSummary_Icon_Evelyn.png",
            glm::vec3(4.25f, 2.02f, 0.0f), glm::vec3(1.05f, 0.99f, 0.0f), true, false, "");
        ...
        UIButton *Suspect4 = new UIButton("Suspect4", "Assets/Images/Journal/CaseSummary_Icon_Archibald.png",
            glm::vec3(1.4f, 0.75f, 0.0f), glm::vec3(1.05f, 0.99f, 0.0f), true, false, "");
        ...
        UIButton *Suspect5 = new UIButton("Suspect5", "Assets/Images/Journal/CaseSummary_Icon_Octavia.png",
            glm::vec3(2.75f, 0.75f, 0.0f), glm::vec3(1.05f, 0.99f, 0.0f), true, false, "");
        ...
        UIButton *TownSquare = new UIButton("TownSquare", "Assets/Images/Journal/CaseSummary_Underline.png",
            glm::vec3(1.64f, -2.03f, 0.0f), glm::vec3(2.33f * 0.95f, 0.61f * 0.95f, 0.0f), true, true,
            "Assets/Fonts/ESA-m.ttf");
        ...
        UIButton *TheHolyChurch = new UIButton("TheHolyChurch", "Assets/Images/Journal/CaseSummary_Underline.png",
            glm::vec3(4.05f, -2.05f, 0.0f), glm::vec3(2.33f * 0.95f, 0.61f * 0.95f, 0.0f), true, true,
            "Assets/Fonts/ESA-m.ttf");
        ...
        UIButton *TheCouncil = new UIButton("TheCouncil", "Assets/Images/Journal/CaseSummary_Underline.png",
            glm::vec3(1.48f, -2.65f, 0.0f), glm::vec3(2.33f * 0.95f, 0.61f * 0.95f, 0.0f), true, true,
            "Assets/Fonts/ESA-m.ttf");
        ...
        UIButton *SupremeCourt = new UIButton("SupremeCourt", "Assets/Images/Journal/CaseSummary_Underline.png",
            glm::vec3(3.95f, -2.65f, 0.0f), glm::vec3(2.33f * 0.95f, 0.61f * 0.95f, 0.0f), true, true,
            "Assets/Fonts/ESA-m.ttf");
        ...
        /*EvidenceButton = new UIButtonEmpty("EvidenceText", glm::vec3(3.2f, -1.0f, 0.0f), glm::vec3(5.0f, 0.5f, 0.0f),
        true, true, "Assets/Fonts/ESA-smb.ttf"); EvidenceButton->SetTextSize(0.55f);
        EvidenceButton->SetTextColor(glm::vec3(0.58, 0.04, 0.00));
        EvidenceButton->SetOnClickAction([this]() { clickEvidenceButton(); });*/

        EvidenceButton = new UIButton("EvidenceText", "Assets/Images/Journal/CaseSummary_Evidence.png",
            glm::vec3(3.18f, -0.47f, 0.0f), glm::vec3(4.75f * 0.95f, 0.92f * 0.95f, 0.0f), true, true,
            "Assets/Fonts/ESA-smb.ttf");
